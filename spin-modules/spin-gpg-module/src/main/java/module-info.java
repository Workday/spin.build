...
module build.spin.module.gpg {
    ...
    provides build.spin.Extension.MetaClass with
        build.spin.module.gpg.SigningService.MetaClass,
        build.spin.module.gpg.SignableResource.MetaClass,
        build.spin.module.gpg.GpgPlugin.MetaClass;
